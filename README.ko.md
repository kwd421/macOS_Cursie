...
- 일반적인 커서 역할 자동 매핑
- 적용하기 전에 애니메이션 커서를 포함한 각 커서 미리보기
- 개별 커서 역할 수동 교체
- 적용할 커서 크기 조절
...
- 애니메이션 `.ani` 커서는 미리보기에서 재생되므로 적용하기 전에 움직임을 확인할 수 있습니다.
...
최신 릴리즈에서 서명된 DMG를 다운로드하세요:
[github.com/kwd421/macOS_Cursie/releases/latest](https://github.com/kwd421/macOS_Cursie/releases/latest)

`Cursie.dmg`를 연 뒤 `Cursie.app`을 `Applications`로 드래그하면 됩니다.

## 업데이트

Cursie는 Sparkle을 사용해 업데이트를 확인하고 앱 안에서 새 버전을 설치합니다.
